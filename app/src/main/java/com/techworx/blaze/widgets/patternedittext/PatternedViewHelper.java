package com.techworx.blaze.widgets.patternedittext;
...
import com.techworx.blaze.widgets.patternedittext.Utils.PatternUtils;

public final class PatternedViewHelper {
                ...
                if (!mForcing) {
                    ...
                    if (after == 0) {
                        ...
                        try {
                            ...
                            //Do nothing. User tried to delete non removable char(s) of pattern.
                        }
                    } else {
                        isDeleting = false;
                    }
